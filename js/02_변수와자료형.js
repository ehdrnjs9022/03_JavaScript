...
{ // 함수 정의 시작
    ...
    { // if 정의 시작
        ...
        //{{}} 바깥족 -> 안쪽 변수 사용 가능!
        console.log("전역 변수 global1 ", globa1)
...
console.log("asight:" , sight, typeof sight);
...
// 1) 배열(Array) : 변수의 묶음, 묶인 변수에 0부터 1씩 증가(index)
