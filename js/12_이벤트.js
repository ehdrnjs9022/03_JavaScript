...
// 전달 인자(Argumnet) :  함수 호출 시 () 안에 작성하는 값
//                        함수 매개변수로 전달됨
...
//querySelectorAl() -> 선택자가 일치하는 요소를 모두 배열 형태(배열)
...
/* 변경하기버튼*/
const chageBtn = document.querySelector("#changeBtn");

const inputs = document.querySelectorAll(".inputColor");
const displays = document.querySelectorAll(".display");
// -> 위 아래로 연결된 .display와 .inputColor의 인덱스번호가 같다
