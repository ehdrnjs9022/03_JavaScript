...
function oddEvenCheck(){
    ...
    // 짝수 == 2의 배수 ==  2로 나눴을때 나머지가 0인 수
    
    //  홀수 == 2의 배수 -1 또ㅡㄴ +1 == 2로 나눴을때 나머지가 1인 수
...
/* 배수 판별기 */
 function multipleCheck(){
    ...
    // 배수 판별기에 사용 되는 요소를 모두 얻어와 변수에 저장
    ...
    /* #result2 요소의 내용로 결과 대입(출력) */
    result2.innerText = (v1 % v2 === 0);

 }

 /*  복합 대입 연산 확인 */
function copoundCheck(){
    let num = 100;
...
function andCheck(){
    ...
    console.log(`104는 100이상의 숫자 이면서 짝수인가?${bool1}`); //true
