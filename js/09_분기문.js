...
function check1(){
    ...
    const stopNumber=Number(prompt("1~20 사이 몀추고 싶은 숫자 입력"));
...
function check2(){
    ...
    let num =1;
    while(true){ // 조건식이 항상 true -> 계속 반복
        // 조건식이 ture일 경우 반복할 코드
        console.log(num++);
